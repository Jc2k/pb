...
async export function ensureNotificationPermission(): Promise<boolean> {
...
async export function notifySessionFinished(session: SessionItem, projects: ProjectEntry[]) {
