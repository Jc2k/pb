...
- [Streaming tool-output control collar](control-collar-plan.md)
  ...
  - [Native Rust world qualification](benchmarks/native-rust-world-qualification.md)
  - [Native Python semantic qualification](benchmarks/native-python-semantic-qualification.md)
  - [Native Rust semantic qualification](benchmarks/native-rust-semantic-qualification.md)
