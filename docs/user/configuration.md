...
fallback targets Python 3.12 on the host platform and includes the exact first-party project plus
bundled typeshed. By default pb also looks for `.venv` and `venv` at the project root and beside
