...
- `scheduler.rs` now owns graph-stage resolution, CMD1 resolved input-state handoff, CMD2/CMD3
  ...
  routing-output validation, full-attention KV placement and execution-shape validation for the
  declared attention math implementation, active expert read issue and finish metrics, route
