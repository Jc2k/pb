...
- `scheduler.rs` now owns graph-stage resolution, CMD2/CMD3 descriptors, CMD2 typed input-state
  validation and resolved input-state handoff, CMD2 post-attention prep output resolution, CMD3
  input and deferred output resolution, routing topK placement validation, declared CMD1
